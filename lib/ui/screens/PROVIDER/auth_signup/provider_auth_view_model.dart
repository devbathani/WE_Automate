...
class ProviderAuthViewModel extends BaseViewModel {
  ...
  Future<bool> createAccount() async {
    ...
    final CustomAuthResponse authResult = await _authService
        .signUpProviderWithEmailPassword(providerUser: providerUser);
    if (authResult.status!) {
      ...
      // customerUser.firstName = authResult.notFirebaseUser.firstName;
      // customerUser!.lastName = authResult.notFirebaseUser.lastName;
  ...
  Future<bool> loginWithEmailPassword() async {
    print("LoginWithUserEmailAndPasswrd====> ${providerUser.toJson()}");
    setState(ViewState.busy);
    final CustomAuthResponse authResult =
        await _authService.loginProviderWithEmailPassword(
