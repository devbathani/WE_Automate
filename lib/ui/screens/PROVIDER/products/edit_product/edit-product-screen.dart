...
class EditProductScreen extends StatefulWidget {
  ...
  const EditProductScreen({this.productToBeEditted});

  @override
  _EditdProductScreenState createState() => _EditdProductScreenState();
}

class _EditdProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    for (int i = 0; i < availableOptions.length; i++) {
      if (availableOptions[i].label ==
          widget.productToBeEditted!.availability) {
        ...
        children: [
          Container(
            ...
            child: TextFormField(
              ...
              controller:
                  TextEditingController(text: widget.productToBeEditted!.title),
              onSaved: (value) {
                widget.productToBeEditted!.title = value;
              },
          ...
          Container(
            ...
            child: TextFormField(
              ...
              controller: TextEditingController(
                  text: widget.productToBeEditted!.description),
              onSaved: (value) {
                widget.productToBeEditted!.description = value;
              },
              textAlign: TextAlign.center,
              decoration: InputDecoration(
                  border: InputBorder.none,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onSaved: (value) {
                widget.productToBeEditted!.price = value;
              },
              controller:
                  TextEditingController(text: widget.productToBeEditted!.price),
              textAlign: TextAlign.center,
          ...
          Container(
            ...
            child: TextFormField(
              controller: TextEditingController(
                  text: widget.productToBeEditted!.category),
              validator: (value) {
                if (value.toString().isEmpty) {
                  return "Invalid field";
                } else {
              ...
              onSaved: (value) {
                widget.productToBeEditted!.category = value;
              },
              textAlign: TextAlign.center,
              decoration: InputDecoration(
                  border: InputBorder.none,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              controller: TextEditingController(
                  text: widget.productToBeEditted!.websiteLink),
              onSaved: (value) {
                widget.productToBeEditted!.websiteLink = value;
              },
              textAlign: TextAlign.center,
              decoration: InputDecoration(
                  border: InputBorder.none,
          ...
          GestureDetector(
            ...
            child: _image != null
                ...
                : FadeInImage.assetNetwork(
                    ...
                    image: widget.productToBeEditted!.imgUrl!,
                    height: 112.h,
                    fit: BoxFit.cover,
                    width: 1.sw,
                  ),
              ...
              child: RoundedRaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      // if (_image != null) {
                      widget.productToBeEditted!.imgFile = _image;

                      widget.productToBeEditted!.providerId =
                          locator<LocalStorageService>().accessTokenProvider;
                      widget.productToBeEditted!.location = Locationn(
                      ...
                      Get.back(result: widget.productToBeEditted!);
                      // } else {
