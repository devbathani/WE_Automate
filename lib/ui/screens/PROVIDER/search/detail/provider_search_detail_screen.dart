...
import 'package:antonx_flutter_template/ui/screens/PROVIDER/search/detail/provider-search-detail-view-model.dart';
...
class ProviderSearchDetailScreen extends StatefulWidget {
  @override
  _ProviderSearchDetailScreenState createState() =>
      _ProviderSearchDetailScreenState();
}

class _ProviderSearchDetailScreenState
    extends State<ProviderSearchDetailScreen> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ProviderSearchDetailViewModel(),
      child: Consumer<ProviderSearchDetailViewModel>(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    searchList(model),
                    model.products.length < 5 ? Container() : seeMoreButton()
                  ],
                ),
              ),
            ),
  ...
  searchList(ProviderSearchDetailViewModel model) {
  ...
  searchTextField(ProviderSearchDetailViewModel model) {
    return Padding(
