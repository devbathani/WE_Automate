                  ...
                  return snapshot.data?.isEmpty == true
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            int duration = data.schedule!
                                .schedule[data.scheduleId].breakDuration;

                            String time = DateFormat("hh:mm a").format(
                                data.schedule!.slots[data.timeslotId].time);
                            String endTime = DateFormat("hh:mm a").format(data
                                .schedule!.slots[data.timeslotId].time
